...
func constructor{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    local signaling_params: ProposalParams = ProposalParams(majority=50, quorum=80, votingDuration=5000, graceDuration=5);
    ...
    // curl http://localhost:5051/predeployed_accounts
